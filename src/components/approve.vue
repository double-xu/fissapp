<template>
  <div class="approve">
    <van-nav-bar title="我的审核" left-arrow @click-left="onClickLeft"/>
    ...
    <van-cell-group>
      <van-cell icon="tosend" value="5" is-link @click="toInpro">
        <template slot="title">
          <span class="van-cell-text">待审核</span>
        </template>
      </van-cell>

      <van-cell icon="passed" value="8" is-link @click="approved">
        <template slot="title">
